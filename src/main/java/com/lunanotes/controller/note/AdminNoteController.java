...
import com.lunanotes.controller.note.docs.AdminNoteAPI;
import com.lunanotes.mapper.note.NoteDTO;
import com.lunanotes.mapper.note.NoteDTOToNoteConverter;
...
@RequestMapping("${api.endpoint.base-url}/admin/notes")
public class AdminNoteController implements AdminNoteAPI {
    ...
    public Result findAllNotes() {
        List<Note> foundNotes = this.noteService.findAllAdmin();
    ...
    public Result updateNote(@PathVariable String noteId, @Valid @RequestBody NoteDTO noteDTO) {
        ...
        Note updatedNote = this.noteService.updateAdmin(noteId, update);
    ...
    public Result deleteNote(@PathVariable String noteId) {
        this.noteService.deleteAdmin(noteId);
    ...
    public Result removeTag(@PathVariable String noteId, @PathVariable String tagId) {
        Note note = noteService.removeTagAdmin(noteId, tagId);
