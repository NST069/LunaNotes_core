...
import com.lunanotes.controller.note.docs.CurrentNoteAPI;
...
@RequestMapping("${api.endpoint.base-url}/notes/me")
public class CurrentNoteController implements CurrentNoteAPI {
